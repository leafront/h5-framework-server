...
.top-bar-search{
  ...
  i{
    width: .34rem;
    height: .34rem;
    background: url(imgPath/static/img/home_sprite.png?v=version) no-repeat -.49rem -.11rem;
...
.top-bar-user{
  ...
  i{
    width: .38rem;
    height: .41rem;
    background: url(imgPath/static/img/home_sprite.png?v=version) .02rem -.04rem no-repeat;
    background-size: .86rem auto;
  }
}
.home-banner {
